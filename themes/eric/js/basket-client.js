...
;(function() {
    ...
    var newsletterFormWrapper = document.getElementById('newsletter_wrapper');
    ...
    function newsletterError(e) {
      alert(JSON.stringify(e));
        ...
        newsletterForm.newsletter_submit.disabled = false;
    }
    ...
    function newsletterSubscribe(evt) {
        ...
        newsletterForm.newsletter_submit.disabled = true;
